...
CREATE SCHEMA hr_dev COLLATE = utf8_general_ci;
...
CREATE TABLE countries (
    ...
    CONSTRAINT countries_regions_region_id FOREIGN KEY (region_id)
...
CREATE TABLE locations (
    ...
    CONSTRAINT locations_countries_country_id FOREIGN KEY (country_id)
...
CREATE TABLE departments (
    ...
    CONSTRAINT departments_locations_location_id FOREIGN KEY (location_id)
...
CREATE TABLE employees (
    ...
    CONSTRAINT employees_jobs_job_id FOREIGN KEY (job_id)
        REFERENCES jobs (job_id),
    CONSTRAINT employees_departments_department_id FOREIGN KEY (department_id)
        REFERENCES departments (department_id),
    CONSTRAINT employees_employees_employee_id FOREIGN KEY (manager_id)
...
CREATE TABLE job_history (
    ...
    job_id VARCHAR(10) NOT NULL,
    department_id INT(11) UNSIGNED NOT NULL,
    CONSTRAINT job_history_employees_employee_id FOREIGN KEY (employee_id)
        REFERENCES employees (employee_id),
    CONSTRAINT job_history_jobs_job_id FOREIGN KEY (job_id)
        REFERENCES jobs (job_id),
    CONSTRAINT job_history_departments_department_id FOREIGN KEY (department_id)
        REFERENCES departments (department_id)
);
